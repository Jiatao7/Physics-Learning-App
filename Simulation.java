...
public class Simulation extends JPanel implements ActionListener {
    ...
    public Simulation() {
        ...
        menuButton.setBackground(Main.color2);
        ...
        submitButton.setFont(new Font("Helvetica Neue", Font.BOLD, 16));
        ...
        velocityValueLabel.setFont(new Font("Helvetica Neue", Font.PLAIN, 20)); // Set font size
        controlPanel.add(velocityValueLabel);
        velocityField.setFont(new Font("Helvetica Neue", Font.PLAIN, 10)); // Set font size
        controlPanel.add(velocityField);
        controlPanel.add(new JLabel("Coefficient of Friction(0.1-0.9):"));
        frictionValueLabel.setFont(new Font("Helvetica Neue", Font.PLAIN, 20)); // Set font size
        controlPanel.add(frictionValueLabel);
        frictionField.setFont(new Font("Helvetica Neue", Font.PLAIN, 10)); // Set font size
        controlPanel.add(frictionField);
        controlPanel.add(new JLabel("Applied Force (N):"));
        forceValueLabel.setFont(new Font("Helvetica Neue", Font.PLAIN, 20)); // Set font size
        controlPanel.add(forceValueLabel);
        forceField.setFont(new Font("Helvetica Neue", Font.PLAIN, 10)); // Set font size
        controlPanel.add(forceField);
        controlPanel.add(new JLabel("Mass (kg):"));
        massValueLabel.setFont(new Font("Helvetica Neue", Font.PLAIN, 20)); // Set font size
        controlPanel.add(massValueLabel);
        massField.setFont(new Font("Helvetica Neue", Font.PLAIN, 10)); // Set font size
        ...
        // other Label
        frictionLabel = new JLabel("Friction(N): " + FRICTION);
        frictionLabel.setFont(new Font("Helvetica Neue", Font.PLAIN, 20));
        ...
        // other Label
        velocityLabel = new JLabel("Velocity(m/s): " + velocity);
        velocityLabel.setFont(new Font("Helvetica Neue", Font.PLAIN, 20));
        ...
        // Label
        forceLabel = new JLabel("Applied Force(N): " + Fa);
        forceLabel.setFont(new Font("Helvetica Neue", Font.PLAIN, 20));
        ...
        distanceLabel.setFont(new Font("Helvetica Neue", Font.PLAIN, 20));
        ...
        button.setBackground(Main.color2);
    ...
    public void updateParameters() {
        ...
        // Rounds values
        FRICTION = Math.round(FRICTION * 100.0) / 100.0;
